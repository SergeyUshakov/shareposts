    ...
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?= URLROOT ?>/users/register" method="post">
                ...
                <div class="row">
                    <div class="col"><input type="submit" value="Register" class="btn btn-success btn-block"></div>
                    <div class="col"><a href="<?= URLROOT ?>/users/login" class="btn btn-light btn-block">Have an account? Login</a></div>
                </div>
            </form>
        </div>
    </div>
